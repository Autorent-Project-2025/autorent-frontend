...
const variantClasses: Record<Variant, string> = {
  ...
  underline:
    "border-b-1 border-transparent hover:text-primary hover:border-primary text-[1rem] font-normal",
};

const buttonClass = computed(() => [
  "cursor-pointer transition duration-300 flex items-center justify-center group/button",
  props.disabled
    ? "pointer-events-none px-6 py-3 font-semibold rounded-2xl text-white bg-slate-500 shadow-(--shadow-s)"
